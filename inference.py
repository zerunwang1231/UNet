...
from Unet__train import dsc_per_volume
...
def main(args):
    ...
    with torch.set_grad_enabled(False):
        unet = NestedUNet(in_channels=Dataset.in_channels)
   ...
   # return 0 # uncomment it if you only want to get loss score
    ...
    for p in volumes:
        ...
        for s in range(x.shape[0]):
            ...
            try:
                ...
                print("cannot save into {}".format(filename))
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--weights",
        type=str,
        default="weights/unet+real.pt",
        help="path to weights file"
    )
    parser.add_argument(
        "--images", type=str, default="assets", help="root folder with images"
    )
    parser.add_argument(
        "--image-size",
        type=int,
